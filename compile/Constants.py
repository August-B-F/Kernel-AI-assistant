...
edit = os.path.join(sys._MEIPASS, "edit.png")
delet = os.path.join(sys._MEIPASS, "delet.png")
...
file = os.path.join(sys._MEIPASS, "file.png")
...
KINDA_BIG_FONT = pygame.font.Font(font_file, 30)
VERY_BIG_FONT = pygame.font.Font(font_file, 40)
...
OPENAI_API_KEY = "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"
