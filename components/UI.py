...
class FileCardLoded:
    def __init__(self, name, path, is_directory, rect):
        ...
        self.delet_image = pygame.image.load("assets/delet.png")
        self.delet_image = pygame.transform.scale(self.delet_image, (50, 50))
        self.edit_image = pygame.image.load("assets/edit.png")
        self.edit_image = pygame.transform.scale(self.edit_image, (50, 50))

        self.icon =  pygame.image.load('assets/pixel/file.png')
...
class files: 
    def __init__(self):
        ...
        self.file_image = pygame.image.load("assets/pixel/file.png")
